...
export const projects = [
  ...
  },
  {
    ...
    description:
      "Wild Oasis is a cabin booking app with Supabase backend, user authentication, React Query for data fetching, and React Router for navigation. Testing Account: test@example.com, password:12345",
  },
  {
    name: "Worldwise",
    links: [
